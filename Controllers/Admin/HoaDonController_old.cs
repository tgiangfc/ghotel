...
//{
//    public class HoaDonController_old : Controller
//    {
...
//        {
//            ViewBag.ma_hd = new SelectList(db.tblChiTietHoaDons, "ma_hd", "ma_hd");
//            ViewBag.ma_nv = new SelectList(db.tblNhanViens, "ma_nv", "ho_ten");
//            ViewBag.ma_tgd = new SelectList(db.tblPhieuDatPhongs, "ma_tgd", "ma_tgd");
...
//        public ActionResult Create([Bind(Include = "ma_hd,ma_nv,ma_tgd,ngay_tra_phong,ma_tinh_trang,phu_thu")] tblHoaDon tblHoaDon)
//        {
...
//            ViewBag.ma_hd = new SelectList(db.tblChiTietHoaDons, "ma_hd", "ma_hd", tblHoaDon.ma_hd);
...
//        [HttpPost]
//        [ValidateAntiForgeryToken]
//        public ActionResult Edit([Bind(Include = "ma_hd,ma_nv,ma_tgd,ngay_tra_phong,ma_tinh_trang,phu_thu")] tblHoaDon tblHoaDon)
//        {
//            if (ModelState.IsValid)
//            {
...
//                ViewBag.ma_nv = nv.ma_nv;
//                ViewBag.ten_nv = nv.ho_ten;
//            }
...
//        public ActionResult Result(String ma_nv, String ma_tgd)
//        {
//            if (ma_nv == null || ma_tgd == null)
//            {
...
//                ct.ma_hd = hd.ma_hd;
//                ct.tien_phong = Double.Parse(tien_phong);
//                ct.tien_dich_vu = Double.Parse(tien_dich_vu);
//                ct.tong_tien = Double.Parse(tong_tien);
